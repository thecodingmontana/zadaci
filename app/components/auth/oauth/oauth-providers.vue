...
<template>
  <div class="grid gap-2 overflow-hidden">
    <div class="flex h-10.5 items-center overflow-hidden!">
      <button
        :disabled="oauth.isSigninWithOauth"
        :class="
          cn(
            'flex h-10.5 w-full items-center justify-center gap-2 rounded border px-2 text-sm font-medium duration-300 hover:border-orange-200',
      ...
      >
        ...
        />
        <Icon v-else name="devicon:google" class="size-4" />
