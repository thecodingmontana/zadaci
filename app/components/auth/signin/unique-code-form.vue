        ...
        <FormControl>
          ...
          >
            <input
              ...
              class="peer block h-11.5 w-full rounded-md border-0 bg-transparent px-3 py-2 ps-9 text-sm placeholder:text-muted-foreground focus:bg-none focus:outline-none active:bg-transparent"
            />
            <div
