...
import type { ConversationDocType, ZadaciDatabase } from "~/plugins/rxdb.client";
import { replicateRxCollection } from "rxdb/plugins/replication";

export function useConversationSync(workspaceId: () => string | undefined) {
  ...
  async function start() {
    ...
    const collection = db.conversations;
    ...
    replicationState = replicateRxCollection({
      replicationIdentifier: `conversations-ws-${wsId}`,
      collection,
      pull: {
