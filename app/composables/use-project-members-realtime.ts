...
import { projectMembersKey } from "./use-project-members";
...
export function useProjectMembersRealtime(projectId: () => string | undefined) {
  ...
  function start() {
    ...
    channel = supabase
      .channel("app_project_members_realtime")
      .on(
        "postgres_changes",
        {
          event: "*",
          schema: "public",
          table: "app_project_members",
