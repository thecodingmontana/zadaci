...
import ProjectKanban from "~/components/workspace/projects/project-kanban.vue";
import ProjectTimeline from "~/components/workspace/projects/project-timeline.vue";
...
const projectsTitle = useWorkspacePageTitle("All Projects");
useSeoMeta({
  title: projectsTitle,
      ...
      >
        ...
        <div class="flex items-start justify-between">
          <div class="flex items-center gap-2.5">
            ...
            <h1 class="text-xl font-semibold tracking-tight">All Projects</h1>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex items-center gap-2">
            <Button size="sm" class="gap-1.5 bg-brand hover:bg-brand-secondary" @click="addProject">
        ...
        >
          <ProjectKanban v-if="activeView === 'kanban'" :workspace-id="workspaceId" />
          <ProjectTimeline v-else :workspace-id="workspaceId" />
        </Motion>
      </Motion>
    </NuxtLayout>
  </NuxtLayout>
