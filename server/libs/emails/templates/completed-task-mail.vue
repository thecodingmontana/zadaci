      ...
      <Container class="mx-auto max-w-162.5 bg-gray-100 p-5">
        ...
        <Container>
          ...
          <Text class="text-base leading-6 text-gray-600">
            The task <strong>{{ task }}</strong> from project <strong>{{ project }}</strong> in
            workspace <strong>{{ workspace }}</strong> has been marked as completed by
        ...
        <Container>
          <Text class="text-sm text-gray-500">
            You received this because you're a member of the project {{ project }} in workspace
            {{ workspace }}.
          </Text>
        </Container>
      </Container>
