      ...
      <Container class="mx-auto max-w-162.5 bg-gray-100 p-5">
        ...
        <Container>
          ...
          <Text class="text-base leading-6 text-gray-600">
            You’ve been added to the project <strong>{{ project }}</strong> in workspace
            <strong>{{ workspace }}</strong> by <strong>{{ addedBy }}</strong
            >.
          </Text>
          <Text class="text-base leading-6 text-gray-600">
            You can now collaborate with your team and manage tasks within the project.
          </Text>
          <Link
            :href="link!"
            class="bg-brand"
        ...
        <Container>
          <Text class="text-sm text-gray-500">
            You received this because you were added to the project {{ project }} in workspace
            {{ workspace }}.
          </Text>
        </Container>
      </Container>
