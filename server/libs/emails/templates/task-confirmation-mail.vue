  ...
  <Html lang="en">
    ...
    >
      <Container class="mx-auto max-w-162.5 bg-gray-100 p-5">
        ...
        <Container>
          <Text class="text-base leading-6 text-gray-600"> Hi {{ user }}, </Text>
          <Text class="text-base leading-6 text-gray-600">
            You’ve been assigned to the task <strong>{{ task }}</strong> under project
            <strong>{{ project }}</strong> in workspace <strong>{{ workspace }}</strong> by
        ...
        <Container>
          <Text class="text-sm text-gray-500">
            You received this because you were assigned to a task in the project {{ project }} in
            workspace {{ workspace }}.
          </Text>
        </Container>
      </Container>
